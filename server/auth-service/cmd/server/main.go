...
func main() {
	...
	// Initialize services
	authService := services.NewAuthService(userRepo, cfg, redisClient)
	...
	// Setup routes
	routes.Setup(router, authController)
